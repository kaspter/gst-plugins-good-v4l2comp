...
static int
gst_v4l2_compositor_get_number_of_sinkpads (GstV4l2Compositor * self)
{
  if (self->number_of_sinkpads >= 0)
    return self->number_of_sinkpads;

  self->number_of_sinkpads = g_list_length (GST_ELEMENT (self)->sinkpads);
  return self->number_of_sinkpads;
}
