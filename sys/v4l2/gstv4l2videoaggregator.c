...
GST_DEBUG_CATEGORY_STATIC (gst_v4l2videoaggregator_debug);
#define GST_CAT_DEFAULT gst_v4l2videoaggregator_debug

/* Needed prototypes */
static void gst_v4l2videoaggregator_reset_qos (GstV4l2VideoAggregator * vagg);
...
G_DEFINE_TYPE (GstV4l2VideoAggregatorPad, gst_v4l2videoaggregator_pad,
    GST_TYPE_V4L2_AGGREGATOR_PAD);

static void
gst_v4l2videoaggregator_pad_get_property (GObject * object, guint prop_id,
...
static void
gst_v4l2videoaggregator_pad_set_property (GObject * object, guint prop_id,
...
_flush_pad (GstV4l2AggregatorPad * aggpad, GstV4l2Aggregator * aggregator)
{
  ...
  gst_v4l2videoaggregator_reset_qos (vagg);
...
static void
gst_v4l2videoaggregator_pad_finalize (GObject * o)
{
  ...
  G_OBJECT_CLASS (gst_v4l2videoaggregator_pad_parent_class)->finalize (o);
}
...
static void
gst_v4l2videoaggregator_pad_class_init (GstV4l2VideoAggregatorPadClass * klass)
{
  GObjectClass *gobject_class = (GObjectClass *) klass;
  GstV4l2AggregatorPadClass *aggpadclass = (GstV4l2AggregatorPadClass *) klass;

  gobject_class->set_property = gst_v4l2videoaggregator_pad_set_property;
  gobject_class->get_property = gst_v4l2videoaggregator_pad_get_property;
  gobject_class->finalize = gst_v4l2videoaggregator_pad_finalize;
...
static void
gst_v4l2videoaggregator_pad_init (GstV4l2VideoAggregatorPad * vaggpad)
{
  vaggpad->priv =
 ...
 *********************************/
static GObject *
gst_v4l2videoaggregator_child_proxy_get_child_by_index (GstChildProxy * child_proxy,
    guint index)
{
  GObject *obj;
...
static guint
gst_v4l2videoaggregator_child_proxy_get_children_count (GstChildProxy * child_proxy)
{
  guint count = 0;
...
static void
gst_v4l2videoaggregator_child_proxy_init (gpointer g_iface, gpointer iface_data)
{
  GstChildProxyInterface *iface = g_iface;

  GST_INFO ("intializing child proxy interface");
  iface->get_child_by_index =
      gst_v4l2videoaggregator_child_proxy_get_child_by_index;
  iface->get_children_count =
      gst_v4l2videoaggregator_child_proxy_get_children_count;
}
...
static void gst_v4l2videoaggregator_init (GstV4l2VideoAggregator * self,
    GstV4l2VideoAggregatorClass * klass);
static void gst_v4l2videoaggregator_class_init (GstV4l2VideoAggregatorClass * klass);
static gpointer gst_v4l2videoaggregator_parent_class = NULL;

GType
gst_v4l2videoaggregator_get_type (void)
{
  ...
  if (g_once_init_enter (&g_define_type_id_volatile)) {
    GType g_define_type_id = g_type_register_static_simple (GST_TYPE_V4L2_AGGREGATOR,
        ...
        (GClassInitFunc) gst_v4l2videoaggregator_class_init,
        sizeof (GstV4l2VideoAggregator),
        (GInstanceInitFunc) gst_v4l2videoaggregator_init,
        (GTypeFlags) G_TYPE_FLAG_ABSTRACT);
    {
      G_IMPLEMENT_INTERFACE (GST_TYPE_CHILD_PROXY,
          gst_v4l2videoaggregator_child_proxy_init);
    }
...
static void
gst_v4l2videoaggregator_find_best_format (GstV4l2VideoAggregator * vagg,
 ...
 *       gst_v4l2videoaggregator_update_src_caps (without releasing
 *       the GST_V4L2_VIDEO_AGGREGATOR_LOCK in between)
 */
static gboolean
gst_v4l2videoaggregator_update_converters (GstV4l2VideoAggregator * vagg)
{
  GList *tmp;
  ...
  GstV4l2VideoAggregatorClass *vagg_class = GST_V4L2_VIDEO_AGGREGATOR_GET_CLASS (vagg);
  ...
  if (vaggpad_class->set_info) {
    ...
    for (tmp = GST_ELEMENT (vagg)->sinkpads; tmp; tmp = tmp->next) {
      GstV4l2VideoAggregatorPad *pad = GST_V4L2_VIDEO_AGGREGATOR_PAD (tmp->data);
...
/* WITH GST_V4L2_VIDEO_AGGREGATOR_LOCK TAKEN */
static gboolean
gst_v4l2videoaggregator_src_setcaps (GstV4l2VideoAggregator * vagg, GstCaps * caps)
{
  GstV4l2Aggregator *agg = GST_V4L2_AGGREGATOR (vagg);
  gboolean ret = FALSE;
  GstVideoInfo info;
...
/* WITH GST_V4L2_VIDEO_AGGREGATOR_LOCK TAKEN */
static gboolean
gst_v4l2videoaggregator_update_src_caps (GstV4l2VideoAggregator * vagg)
{
  GList *l;
  ...
  if (best_width > 0 && best_height > 0 && best_fps > 0) {
    ...
    if (gst_v4l2videoaggregator_src_setcaps (vagg, caps)) {
...
static gboolean
gst_v4l2videoaggregator_pad_sink_setcaps (GstPad * pad, GstObject * parent,
    GstCaps * caps)
{
  GstV4l2VideoAggregator *vagg;
...
static gboolean
gst_v4l2videoaggregator_caps_has_alpha (GstCaps * caps)
{
...
static GstCaps *
gst_v4l2videoaggregator_pad_sink_getcaps (GstPad * pad, GstV4l2VideoAggregator * vagg,
    GstCaps * filter)
{
  GstCaps *srccaps;
  ...
  has_alpha = gst_v4l2videoaggregator_caps_has_alpha (srccaps);
...
static void
gst_v4l2videoaggregator_update_qos (GstV4l2VideoAggregator * vagg, gdouble proportion,
...
static void
gst_v4l2videoaggregator_reset_qos (GstV4l2VideoAggregator * vagg)
{
  gst_v4l2videoaggregator_update_qos (vagg, 0.5, 0, GST_CLOCK_TIME_NONE);
  vagg->priv->qos_processed = vagg->priv->qos_dropped = 0;
}

static void
gst_v4l2videoaggregator_read_qos (GstV4l2VideoAggregator * vagg, gdouble * proportion,
    GstClockTime * time)
{
  GST_OBJECT_LOCK (vagg);
...
static void
gst_v4l2videoaggregator_reset (GstV4l2VideoAggregator * vagg)
{
  GstV4l2Aggregator *agg = GST_V4L2_AGGREGATOR (vagg);
  GList *l;
...
static gint
gst_v4l2videoaggregator_fill_queues (GstV4l2VideoAggregator * vagg,
...
gst_v4l2videoaggregator_do_aggregate (GstV4l2VideoAggregator * vagg,
...
static gint64
gst_v4l2videoaggregator_do_qos (GstV4l2VideoAggregator * vagg, GstClockTime timestamp)
{
  GstV4l2Aggregator *agg = GST_V4L2_AGGREGATOR (vagg);
  ...
  gst_v4l2videoaggregator_read_qos (vagg, &proportion, &earliest_time);
...
static GstClockTime
gst_v4l2videoaggregator_get_next_time (GstV4l2Aggregator * agg)
{
...
static GstFlowReturn
gst_v4l2videoaggregator_check_reconfigure (GstV4l2VideoAggregator * vagg,
    gboolean timeout)
{
  ...
  if (GST_VIDEO_INFO_FORMAT (&vagg->info) == GST_VIDEO_FORMAT_UNKNOWN
    ...
    ret = gst_v4l2videoaggregator_update_converters (vagg);
    if (ret)
      ret = gst_v4l2videoaggregator_update_src_caps (vagg);
...
static GstFlowReturn
gst_v4l2videoaggregator_aggregate (GstV4l2Aggregator * agg, gboolean timeout)
{
  ...
  flow_ret = gst_v4l2videoaggregator_check_reconfigure (vagg, timeout);
  ...
  if (output_end_time == output_start_time) {
    ...
    flow_ret =
        gst_v4l2videoaggregator_fill_queues (vagg, output_start_running_time,
        output_end_running_time);
  }
  ...
  jitter = gst_v4l2videoaggregator_do_qos (vagg, output_start_time);
  if (jitter <= 0) {
    flow_ret = gst_v4l2videoaggregator_do_aggregate (vagg, output_start_time,
 ...
 */
static gboolean
gst_v4l2videoaggregator_query_duration (GstV4l2VideoAggregator * vagg, GstQuery * query)
{
  GValue item = { 0 };
  gint64 max;
  gboolean res;
...
static gboolean
gst_v4l2videoaggregator_src_query (GstV4l2Aggregator * agg, GstQuery * query)
{
  GstV4l2VideoAggregator *vagg = GST_V4L2_VIDEO_AGGREGATOR (agg);
  gboolean res = FALSE;
  ...
  switch (GST_QUERY_TYPE (query)) {
    ...
    case GST_QUERY_DURATION:
      res = gst_v4l2videoaggregator_query_duration (vagg, query);
      break;
    case GST_QUERY_LATENCY:
      res =
          GST_V4L2_AGGREGATOR_CLASS (gst_v4l2videoaggregator_parent_class)->src_query
          (agg, query);
...
static gboolean
gst_v4l2videoaggregator_src_event (GstV4l2Aggregator * agg, GstEvent * event)
{
  GstV4l2VideoAggregator *vagg = GST_V4L2_VIDEO_AGGREGATOR (agg);
  ...
  switch (GST_EVENT_TYPE (event)) {
    case GST_EVENT_QOS:
    {
      ...
      gst_v4l2videoaggregator_update_qos (vagg, proportion, diff, timestamp);
      break;
    }
    case GST_EVENT_SEEK:
    {
  ...
  return
      GST_V4L2_AGGREGATOR_CLASS (gst_v4l2videoaggregator_parent_class)->src_event (agg,
      event);
}

static GstFlowReturn
gst_v4l2videoaggregator_flush (GstV4l2Aggregator * agg)
{
  GList *l;
  gdouble abs_rate;
  GstV4l2VideoAggregator *vagg = GST_V4L2_VIDEO_AGGREGATOR (agg);
...
static gboolean
gst_v4l2videoaggregator_sink_event (GstV4l2Aggregator * agg, GstV4l2AggregatorPad * bpad,
    GstEvent * event)
{
  GstV4l2VideoAggregator *vagg = GST_V4L2_VIDEO_AGGREGATOR (agg);
  ...
  switch (GST_EVENT_TYPE (event)) {
    case GST_EVENT_CAPS:
    {
      ...
      ret =
          gst_v4l2videoaggregator_pad_sink_setcaps (GST_PAD (pad),
  ...
  if (event != NULL)
    return GST_V4L2_AGGREGATOR_CLASS (gst_v4l2videoaggregator_parent_class)->sink_event
        (agg, bpad, event);
...
static gboolean
gst_v4l2videoaggregator_start (GstV4l2Aggregator * agg)
{
  GstV4l2VideoAggregator *vagg = GST_V4L2_VIDEO_AGGREGATOR (agg);
...
static gboolean
gst_v4l2videoaggregator_stop (GstV4l2Aggregator * agg)
{
  GstV4l2VideoAggregator *vagg = GST_V4L2_VIDEO_AGGREGATOR (agg);

  gst_v4l2videoaggregator_reset (vagg);
...
/* GstElement vmethods */
static GstPad *
gst_v4l2videoaggregator_request_new_pad (GstElement * element,
    GstPadTemplate * templ, const gchar * req_name, const GstCaps * caps)
{
  ...
  vaggpad = (GstV4l2VideoAggregatorPad *)
      GST_ELEMENT_CLASS (gst_v4l2videoaggregator_parent_class)->request_new_pad
...
static void
gst_v4l2videoaggregator_release_pad (GstElement * element, GstPad * pad)
{
  ...
  GST_ELEMENT_CLASS (gst_v4l2videoaggregator_parent_class)->release_pad (GST_ELEMENT
      (vagg), pad);
...
static GstFlowReturn
gst_v4l2videoaggregator_get_output_buffer (GstV4l2VideoAggregator * videoaggregator,
    GstBuffer ** outbuf)
{
  guint outsize;
  static GstAllocationParams params = { 0, 15, 0, 0, };
...
static gboolean
gst_v4l2videoaggregator_pad_sink_acceptcaps (GstPad * pad,
...
static gboolean
gst_v4l2videoaggregator_sink_query (GstV4l2Aggregator * agg, GstV4l2AggregatorPad * bpad,
    GstQuery * query)
{
  GstV4l2VideoAggregator *vagg = GST_V4L2_VIDEO_AGGREGATOR (agg);
  GstV4l2VideoAggregatorPad *pad = GST_V4L2_VIDEO_AGGREGATOR_PAD (bpad);
  ...
  switch (GST_QUERY_TYPE (query)) {
    case GST_QUERY_CAPS:
    {
      ...
      caps = gst_v4l2videoaggregator_pad_sink_getcaps (GST_PAD (pad), vagg, filter);
    ...
    case GST_QUERY_ACCEPT_CAPS:
    {
      ...
      ret = gst_v4l2videoaggregator_pad_sink_acceptcaps (GST_PAD (pad), vagg, caps);
    ...
    default:
      ret =
          GST_V4L2_AGGREGATOR_CLASS (gst_v4l2videoaggregator_parent_class)->sink_query
          (agg, bpad, query);
      break;
  }
  return ret;
...
/* GObject vmethods */
static void
gst_v4l2videoaggregator_finalize (GObject * o)
{
  GstV4l2VideoAggregator *vagg = GST_V4L2_VIDEO_AGGREGATOR (o);

  g_mutex_clear (&vagg->priv->lock);

  G_OBJECT_CLASS (gst_v4l2videoaggregator_parent_class)->finalize (o);
}

static void
gst_v4l2videoaggregator_dispose (GObject * o)
{
  GstV4l2VideoAggregator *vagg = GST_V4L2_VIDEO_AGGREGATOR (o);

  gst_caps_replace (&vagg->priv->current_caps, NULL);

  G_OBJECT_CLASS (gst_v4l2videoaggregator_parent_class)->dispose (o);
}

static void
gst_v4l2videoaggregator_get_property (GObject * object,
...
static void
gst_v4l2videoaggregator_set_property (GObject * object,
...
/* GObject boilerplate */
static void
gst_v4l2videoaggregator_class_init (GstV4l2VideoAggregatorClass * klass)
{
  GObjectClass *gobject_class = (GObjectClass *) klass;
  ...
  gobject_class->finalize = gst_v4l2videoaggregator_finalize;
  gobject_class->dispose = gst_v4l2videoaggregator_dispose;

  gobject_class->get_property = gst_v4l2videoaggregator_get_property;
  gobject_class->set_property = gst_v4l2videoaggregator_set_property;

  gstelement_class->request_new_pad =
      GST_DEBUG_FUNCPTR (gst_v4l2videoaggregator_request_new_pad);
  gstelement_class->release_pad =
      GST_DEBUG_FUNCPTR (gst_v4l2videoaggregator_release_pad);

  agg_class->sinkpads_type = GST_TYPE_V4L2_VIDEO_AGGREGATOR_PAD;
  agg_class->start = gst_v4l2videoaggregator_start;
  agg_class->stop = gst_v4l2videoaggregator_stop;
  agg_class->sink_query = gst_v4l2videoaggregator_sink_query;
  agg_class->sink_event = gst_v4l2videoaggregator_sink_event;
  agg_class->flush = gst_v4l2videoaggregator_flush;
  agg_class->aggregate = gst_v4l2videoaggregator_aggregate;
  agg_class->src_event = gst_v4l2videoaggregator_src_event;
  agg_class->src_query = gst_v4l2videoaggregator_src_query;
  agg_class->get_next_time = gst_v4l2videoaggregator_get_next_time;

  klass->find_best_format = gst_v4l2videoaggregator_find_best_format;
  klass->get_output_buffer = gst_v4l2videoaggregator_get_output_buffer;
...
static void
gst_v4l2videoaggregator_init (GstV4l2VideoAggregator * vagg,
    GstV4l2VideoAggregatorClass * klass)
{
